...
extern const NSString * CS_ToastPositionTop;
extern const NSString * CS_ToastPositionCenter;
extern const NSString * CS_ToastPositionBottom;
...
/**
 ...
 @param position The toast's center point. Can be one of the predefined CS_ToastPosition
...
/**
 `CS_ToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `CS_ToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */
@interface CS_ToastStyle : NSObject
...
/**
 Creates a new instance of `CS_ToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `CS_ToastStyle`.
 */
...
/**
 `CS_ToastManager` provides general configuration options for all toast
 notifications. Backed by a singleton instance.
 */
@interface CS_ToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `CS_ToastStyle`'s default
 style.
...
/**
 ...
 Default is `CS_ToastPositionBottom`.
 
 @param position The default center point. Can be one of the predefined
 CS_ToastPosition constants or a `CGPoint` wrapped in an `NSValue` object.
 */
+ (void)setDefaultPosition:(id)position;

/**
 Returns the default toast position. Default is `CS_ToastPositionBottom`.
